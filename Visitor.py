...
class Visitor(AbstractVisitor):
    ...
    def visitBuiltinIdentifier(self, BuiltinIdentifier):
        print(BuiltinIdentifier.nome, end='')
    ...
    def visitExpr_BuiltinIdentifier_String(self, Expr_BuiltinIdentifier_String):
        ...
        print('(', end='')
        print(Expr_BuiltinIdentifier_String.string, end='')
        print(')', end='')
    ...
    def visitExpr_Expr_Plus_Expr(self,Expr_Expr_Plus_Expr):
        Expr_Expr_Plus_Expr.expr1.accept(self)

        print('+', end='')

        Expr_Expr_Plus_Expr.expr2.accept(self)


    def visitExpr_Id(self,Expr_Id):
        print(Expr_Id.id,end='')
    ...
    def visitExpr_Expr_Minus_Expr(self,Expr_Expr_Minus_Expr):
        Expr_Expr_Minus_Expr.expr1.accept(self)
        print('-',end='')
        Expr_Expr_Minus_Expr.expr2.accept(self)
    ...
    def visitExpr_Expr_Asterisk_Expr(self,Expr_Expr_Asterisk_Expr):
        Expr_Expr_Asterisk_Expr.expr1.accept(self)
        print('*',end='')
        Expr_Expr_Asterisk_Expr.expr2.accept(self)


    def visitExpr_Id_Rarrow_Expr(self,Expr_Id_Rarrow_Expr):
        print(Expr_Id_Rarrow_Expr.id, end='')
        print(' > ', end='')
        Expr_Id_Rarrow_Expr.expr.accept(self)


    def visitExpr_Id_Larrow_Expr(self,Expr_Id_Larrow_Expr):
        print(Expr_Id_Larrow_Expr.id, end='')
        print(' < ', end='')
    ...
    def visitDecl_Interna_Var_Tipo_Retorno_Expr_Decl_Interna(
        self,
        Decl_Interna_Var_Tipo_Retorno_Expr_Decl_Interna):
            ...
            if hasattr(Decl_Interna_Var_Tipo_Retorno_Expr_Decl_Interna.decl_interna,'accept'):
    ...
    def visitDecl_Interna_Equal_Expr(self,Decl_Interna_Equal_Expr):
        print(Decl_Interna_Equal_Expr.id,end='')
        print(' = ',end='')
    ...
    def visitDecl_Interna_For_Decl_Interna(self,Decl_Interna_For_Decl_Interna):
        ...
        print(')',end='')
        print('|',end='')
        print(Decl_Interna_For_Decl_Interna.id,end='')
        print('|',end='')
        print('{',end='')
