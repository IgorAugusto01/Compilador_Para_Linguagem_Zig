...
def p_funcao_pub_fn_params_tipo_retorno_decl_interna(p):
    ...
    p[0] = sa.Funcao_Pub_Fn_Params_Tipo_Retorno_Decl_Interna(p[3], p[5], p[7], p[9])


def p_funcao_pub_fn_tipo_retorno_decl_interna(p):
    '''funcao : PUB FN ID LPAREN RPAREN tipo_retorno LBRACE decl_interna RBRACE'''
    p[0] = sa.Funcao_Pub_Fn_Tipo_Retorno_Decl_Interna(p[3], p[6], p[8])
...
def p_funcao_fn_params_tipo_retorno(p):
    ...
    p[0] = sa.Funcao_Fn_Params_Tipo_Retorno(p[2],p[4], p[6])
...
def p_funcao_fn_tipo_retorno(p):
    ...
    p[0] = sa.Funcao_Fn_Tipo_Retorno(p[2],p[5])
...
def p_params_id_tipo_retorno(p):
    ...
    p[0] = sa.Params_Id_Tipo_Retorno(p[1],p[3])
    
def p_params_id_tipo_retorno_params(p):
    
    '''params : ID COLON tipo_retorno COMMA params'''
    
    p[0] = sa.Params_Id_Tipo_Retorno_Params(p[1],p[3],p[5])
...
def p_args_string_args(p):
    ...
    '''
    p[0] = sa.Args_String_Args(p[1],p[3])
...
def p_decl_var_tipo_retorno_expr(p):
    ...
    '''
    p[0] = sa.Decl_Var_Tipo_Retorno_Expr(p[2],p[4], p[6])
...
def p_decl_const_expr(p):
    ...
    '''
    p[0] = sa.Decl_Const_Expr(p[2],p[4])
...
def p_decl_const_tipo_retorno_expr(p):
    ...
    '''
    p[0] = sa.Decl_Const_Tipo_Retorno_Expr(p[2],p[4], p[6])

def p_decl_equal_expr(p):
    '''
    decl : ID EQUAL expr SEMICOLON
    '''
    p[0] = sa.Decl_Equal_Expr(p[1],p[3])
...
def p_decl_id_plusequal_expr(p):
    ...
    '''
    p[0] = sa.Decl_Id_PlusEqual_Expr(p[1],p[3])
...
def p_decl_id_pluspercent_expr(p):
    ...
    '''
    p[0] = sa.Decl_Id_PlusPercent_Expr(p[1],p[3])
...
def p_decl_id_pluspercentequal_expr(p):
    ...
    '''
    p[0] = sa.Decl_Id_PlusPercentEqual_Expr(p[1],p[3])
...
def p_decl_id_pluspipe_expr(p):
    ...
    '''
    p[0] = sa.Decl_Id_PlusPipe_Expr(p[1],p[3])
...
def p_decl_id_pluspipeequal_expr(p):
    ...
    '''
    p[0] = sa.Decl_Id_PlusPipeEqual_Expr(p[1],p[3])
...
def p_decl_id_minusequal_expr(p):
    ...
    '''
    p[0] = sa.Decl_Id_MinusEqual_Expr(p[1],p[3])
...
def p_decl_id_minuspercent_expr(p):
    ...
    '''
    p[0] = sa.Decl_Id_MinusPercent_Expr(p[1],p[3])
...
def p_decl_id_minuspercentequal_expr(p):
    ...
    '''
    p[0] = sa.Decl_Id_MinusPercentEqual_Expr(p[1],p[3])
...
def p_decl_id_minuspipe_expr(p):
    ...
    '''
    p[0] = sa.Decl_Id_MinusPipe_Expr(p[1],p[3])
...
def p_decl_id_minuspipeequal_expr(p):
    ...
    '''
    p[0] = sa.Decl_Id_MinusPipeEqual_Expr(p[1],p[3])
...
def p_expr_id_rarrow_expr(p):
    ...
    expr : ID RARROW expr
    '''
    p[0] = sa.Expr_Id_Rarrow_Expr(p[1],p[3])
...
def p_expr_id_larrow_expr(p):
    ...
    expr : ID LARROW expr
    '''
    p[0] = sa.Expr_Id_Larrow_Expr(p[1],p[3])
...
def p_expr_id_percent_expr(p):
    ...
    '''
    p[0] = sa.Expr_Id_Percent_Expr(p[1],p[3])
...
def p_expr_id_equalequal_expr(p):
    ...
    '''
    p[0] = sa.Expr_Id_EqualEqual_Expr(p[1],p[3])
...
def p_expr_id_and_expr(p):
    ...
    expr : ID AND expr
    '''
    p[0] = sa.Expr_Id_And_Expr(p[1],p[3])
...
def p_expr_id_or_expr(p):
    ...
    expr : ID OR expr
    '''
    p[0] = sa.Expr_Id_Or_Expr(p[1],p[3])
...
def p_decl_interna_return_expr(p):
    ...
    '''
    p[0] = sa.Decl_Interna_Return_Expr(p[1],p[2])
...
def p_decl_interna_const_expr(p):
    ...
    '''
    p[0] = sa.Decl_Interna_Const_Expr(p[2],p[4])
...
def p_decl_interna_const_tipo_retorno_expr(p):
    ...
    '''
    p[0] = sa.Decl_Interna_Const_Tipo_Retorno_Expr(p[2],p[4], p[6])
...
def p_decl_interna_equal_expr(p):
    ...
    '''
    p[0] = sa.Decl_Interna_Equal_Expr(p[1],p[3])
...
def p_decl_interna_plusequal_expr(p):
    ...
    '''
    p[0] = sa.Decl_Interna_PlusEqual_Expr(p[1],p[3])
...
def p_decl_interna_pluspercent_expr(p):
    ...
    '''
    p[0] = sa.Decl_Interna_PlusPercent_Expr(p[1],p[3])
...
def p_decl_interna_pluspercentequal_expr(p):
    ...
    '''
    p[0] = sa.Decl_Interna_PlusPercentEqual_Expr(p[1],p[3])
...
def p_decl_interna_pluspipe_expr(p):
    ...
    '''
    p[0] = sa.Decl_Interna_PlusPipe_Expr(p[1],p[3])
...
def p_decl_interna_equal_expr_decl_interna(p):
    ...
    '''
    p[0] = sa.Decl_Interna_Equal_Expr_Decl_Interna(p[1],p[3], p[5])
...
def p_decl_interna_plusequal_expr_decl_interna(p):
    ...
    '''
    p[0] = sa.Decl_Interna_PlusEqual_Expr_Decl_Interna(p[1],p[3], p[5])
...
def p_decl_interna_pluspercent_expr_decl_interna(p):
    ...
    '''
    p[0] = sa.Decl_Interna_PlusPercent_Expr_Decl_Interna(p[1],p[3], p[5])
...
def p_decl_interna_pluspercentequal_expr_decl_interna(p):
    ...
    '''
    p[0] = sa.Decl_Interna_PlusPercentEqual_Expr_Decl_Interna(p[1],p[3], p[5])
...
def p_decl_interna_pluspipe_expr_decl_interna(p):
    ...
    '''
    p[0] = sa.Decl_Interna_PlusPipe_Expr_Decl_Interna(p[1],p[3], p[5])
...
def p_decl_interna_pluspipeequal_expr(p):
    ...
    '''
    p[0] = sa.Decl_Interna_PlusPipeEqual_Expr(p[1],p[3])
...
def p_decl_interna_minusequal_expr(p):
    ...
    '''
    p[0] = sa.Decl_Interna_MinusEqual_Expr(p[1],p[3])
...
def p_decl_interna_minuspercent_expr(p):
    ...
    '''
    p[0] = sa.Decl_Interna_MinusPercent_Expr(p[1],p[3])
...
def p_decl_interna_minuspercentequal_expr(p):
    ...
    '''
    p[0] = sa.Decl_Interna_MinusPercentEqual_Expr(p[1],p[3])
...
def p_decl_interna_minuspipe_expr(p):
    ...
    '''
    p[0] = sa.Decl_Interna_MinusPipe_Expr(p[1],p[3])
...
def p_decl_interna_minuspipeequal_expr(p):
    ...
    '''
    p[0] = sa.Decl_Interna_MinusPipeEqual_Expr(p[1],p[3])
...
def p_decl_interna_pluspipeequal_expr_decl_interna(p):
    ...
    '''
    p[0] = sa.Decl_Interna_PlusPipeEqual_Expr_Decl_Interna(p[1],p[3], p[5])
...
def p_decl_interna_minusequal_expr_decl_interna(p):
    ...
    '''
    p[0] = sa.Decl_Interna_MinusEqual_Expr_Decl_Interna(p[1],p[3], p[5])
...
def p_decl_interna_minuspercent_expr_decl_interna(p):
    ...
    '''
    p[0] = sa.Decl_Interna_MinusPercent_Expr_Decl_Interna(p[1],p[3], p[5])
...
def p_decl_interna_minuspercentequal_expr_decl_interna(p):
    ...
    '''
    p[0] = sa.Decl_Interna_MinusPercentEqual_Expr_Decl_Interna(p[1],p[3], p[5])
...
def p_decl_interna_minuspipe_expr_decl_interna(p):
    ...
    '''
    p[0] = sa.Decl_Interna_MinusPipe_Expr_Decl_Interna(p[1],p[3], p[5])
...
def p_decl_interna_minuspipeequal_expr_decl_interna(p):
    ...
    '''
    p[0] = sa.Decl_Interna_MinusPipeEqual_Expr_Decl_Interna(p[1],p[3], p[5])
...
def p_decl_interna_break_decl_interna(p):
    ...
    '''
    p[0] = sa.Decl_Interna_Break_Decl_Interna(p[1],p[3])
